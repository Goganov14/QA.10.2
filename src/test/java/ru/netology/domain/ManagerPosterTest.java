...
class ManagerPosterTest {
    ...
    FilmsItem first = new FilmsItem(100, 1, "First film");
    FilmsItem second = new FilmsItem(220, 2, "Second film");
    FilmsItem third = new FilmsItem(33330, 3, "Third film");
    FilmsItem fourth = new FilmsItem(33330, 3, "Fourth film");
    FilmsItem fifth = new FilmsItem(33330, 3, "Fifth film");
    FilmsItem sixth = new FilmsItem(33330, 3, "Sixth film");
    FilmsItem seventh = new FilmsItem(33330, 3, "Seventh film");
    FilmsItem eighth = new FilmsItem(33330, 3, "Eighth film");
    FilmsItem ninth = new FilmsItem(33330, 3, "Ninth film");
    FilmsItem tenth = new FilmsItem(33330, 3, "Tenth film");
    FilmsItem eleventh = new FilmsItem(33330, 3, "Elevetth film");
